...
The second one is the I-V characteristics under different temperatures for high and low doping levels respectively. From this figure, one can see how sufficient doping levels can lead to ohmic behavior for the edge contact.
